...
async def _generate_profile_card(
    ...
    # rank badge — solid yellow bg, white text
    def ordinal(n):
        s = {1:"ST",2:"ND",3:"RD"}
    ...
    bx1 = W - 44 - btw - pad*2
    by1, by2 = 36, 82
    draw.rounded_rectangle([(bx1, by1), (W-44, by2)], radius=10, fill=(255,185,0))
    tw = int(draw.textlength(badge_text, font=f22))
    cx = bx1 + ((W-44 - bx1) - tw) // 2
    cy = by1 + ((by2 - by1) - 22) // 2
    draw.text((cx, cy), badge_text, fill=(255,255,255), font=f22)
