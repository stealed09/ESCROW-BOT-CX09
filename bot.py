...
async def _generate_profile_card(
    ...
    GREEN = (50, 215, 120);  GOLD  = (255, 185, 0)
    ...
    draw.text((178, 55), first_name.upper()[:16], fill=WHITE, font=f56)
    draw.text((180, 120), f"@{username}", fill=GRAY, font=f22)
    ...
    for i,(lbl,val,unit) in enumerate(stats_d):
        ...
        fv = f36 if draw.textlength(val, font=f36) < box_w-20 else f28
