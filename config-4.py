...
class BotState:
    def __init__(self):
        ...
        self.dispute_group_id  = None   # ← group where ALL disputes are forwarded
        self.sub_admins        = set()
        self.fee_percent       = 1.0
        self.bio_discount_percent = 0.0  # fee % when bio matches (0 = free, else custom)
        ...
        # Vouch system
        self.vouch_group_id    = None   # group where vouches are forwarded
        self.vouch_enabled     = True   # admin can toggle on/off
