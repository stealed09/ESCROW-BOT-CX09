...
async def _generate_profile_card(
    ...
    try:
        ...
        f72=ImageFont.truetype(fb,72); f56=ImageFont.truetype(fb,56)
        f44=ImageFont.truetype(fb,44); f36=ImageFont.truetype(fb,36)
        f32=ImageFont.truetype(fb,32); f28=ImageFont.truetype(fb,28)
        f24=ImageFont.truetype(fn,24); f20=ImageFont.truetype(fn,20)
        f18=ImageFont.truetype(fn,18); f16=ImageFont.truetype(fn,16)
    except Exception:
        f72=f56=f44=f36=f32=f28=f24=f20=f18=f16=ImageFont.load_default()
